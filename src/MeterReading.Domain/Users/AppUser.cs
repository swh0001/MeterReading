...
namespace MeterReading.Users
{
    ...
    public class AppUser : FullAuditedAggregateRoot<Guid>, IUser
    {
         ...
         *
         * 1. Update MeterReadingDbContext.OnModelCreating
         * to configure the mapping for your new property
         * 2. Update MeterReadingEfCoreEntityExtensionMappings to extend the IdentityUser entity
